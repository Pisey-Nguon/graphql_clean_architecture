...
Query$GetLocation _parserFn$Query$GetLocation(Map<String, dynamic> data) =>
    Query$GetLocation.fromJson(data);
typedef OnQueryComplete$Query$GetLocation =
    FutureOr<void> Function(Map<String, dynamic>?, Query$GetLocation?);

class Options$Query$GetLocation
    extends graphql.QueryOptions<Query$GetLocation> {
  Options$Query$GetLocation({
    String? operationName,
    required Variables$Query$GetLocation variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Query$GetLocation? typedOptimisticResult,
    Duration? pollInterval,
    graphql.Context? context,
    OnQueryComplete$Query$GetLocation? onComplete,
    graphql.OnQueryError? onError,
       ...
       super(
         ...
         onComplete: onComplete == null
             ...
             : (data) => onComplete(
                 data,
                 data == null ? null : _parserFn$Query$GetLocation(data),
               ),
         onError: onError,
         document: documentNodeQueryGetLocation,
         parserFn: _parserFn$Query$GetLocation,
       );

  final OnQueryComplete$Query$GetLocation? onCompleteWithParsed;
...
class WatchOptions$Query$GetLocation
    extends graphql.WatchQueryOptions<Query$GetLocation> {
  WatchOptions$Query$GetLocation({
    String? operationName,
    required Variables$Query$GetLocation variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
class FetchMoreOptions$Query$GetLocation extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$GetLocation({
...
extension ClientExtension$Query$GetLocation on graphql.GraphQLClient {
  Future<graphql.QueryResult<Query$GetLocation>> query$GetLocation(
    Options$Query$GetLocation options,
  ) async => await this.query(options);

  graphql.ObservableQuery<Query$GetLocation> watchQuery$GetLocation(
    WatchOptions$Query$GetLocation options,
  ) => this.watchQuery(options);

  void writeQuery$GetLocation({
    required Query$GetLocation data,
    required Variables$Query$GetLocation variables,
    bool broadcast = true,
  }) => this.writeQuery(
    graphql.Request(
      operation: graphql.Operation(document: documentNodeQueryGetLocation),
      variables: variables.toJson(),
    ),
    data: data.toJson(),
    broadcast: broadcast,
  ...
  Query$GetLocation? readQuery$GetLocation({
    required Variables$Query$GetLocation variables,
    ...
    return result == null ? null : Query$GetLocation.fromJson(result);
  }
}

graphql_flutter.QueryHookResult<Query$GetLocation> useQuery$GetLocation(
  Options$Query$GetLocation options,
) => graphql_flutter.useQuery(options);
graphql.ObservableQuery<Query$GetLocation> useWatchQuery$GetLocation(
  WatchOptions$Query$GetLocation options,
) => graphql_flutter.useWatchQuery(options);

class Query$GetLocation$Widget
    extends graphql_flutter.Query<Query$GetLocation> {
  Query$GetLocation$Widget({
    widgets.Key? key,
    required Options$Query$GetLocation options,
    required graphql_flutter.QueryBuilder<Query$GetLocation> builder,
