...
graphql_flutter.QueryHookResult<Query$GetEpisode> useQuery$GetEpisode(
  Options$Query$GetEpisode options,
) => graphql_flutter.useQuery(options);
graphql.ObservableQuery<Query$GetEpisode> useWatchQuery$GetEpisode(
  WatchOptions$Query$GetEpisode options,
) => graphql_flutter.useWatchQuery(options);

class Query$GetEpisode$Widget extends graphql_flutter.Query<Query$GetEpisode> {
  Query$GetEpisode$Widget({
    widgets.Key? key,
    required Options$Query$GetEpisode options,
    required graphql_flutter.QueryBuilder<Query$GetEpisode> builder,
