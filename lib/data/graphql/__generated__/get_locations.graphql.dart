...
typedef OnQueryComplete$Query$GetLocations =
    FutureOr<void> Function(Map<String, dynamic>?, Query$GetLocations?);

class Options$Query$GetLocations
    extends graphql.QueryOptions<Query$GetLocations> {
  Options$Query$GetLocations({
    String? operationName,
    required Variables$Query$GetLocations variables,
...
extension ClientExtension$Query$GetLocations on graphql.GraphQLClient {
  ...
  void writeQuery$GetLocations({
    ...
    graphql.Request(
      operation: graphql.Operation(document: documentNodeQueryGetLocations),
      variables: variables.toJson(),
    ),
    data: data.toJson(),
    broadcast: broadcast,
  ...
  Query$GetLocations? readQuery$GetLocations({
    required Variables$Query$GetLocations variables,
